<div class="wrap">
    ...
    <form method="post">
        ...
        <table class="form-table">
            ...
            <tr><th><?php esc_html_e('Выбрать на карте', 'world-map-blips'); ?></th><td><div id="wm-map-picker"><img src="https://upload.wikimedia.org/wikipedia/commons/8/80/World_map_-_low_resolution.svg" alt="map"/></div><p class="description"><?php esc_html_e('Кликните по мини-карте, чтобы заполнить X/Y.', 'world-map-blips'); ?></p></td></tr>
